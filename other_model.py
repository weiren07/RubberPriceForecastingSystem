...
Original file is located at
    https://colab.research.google.com/drive/1qEqWLqUWok6VVkwavWy0IsUfatFpbUbt
...
# Define the model
model = Sequential()
model.add(LSTM(units=70, activation='relu', input_shape=(n_steps, n_features), return_sequences=True))
